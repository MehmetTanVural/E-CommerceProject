        ...
        public ActionResult Register(Register model)
        {
            if (ModelState.IsValid)
            {
               ...
               IdentityResult result = UserManager.Create(user, model.Password);
                ...
                if (result.Succeeded)
                {
                    //kullanıcı oluştu ve bir role atandı
            ...
            if (ModelState.IsValid)
            {
               ...
               var user = UserManager.Find(model.UserName, model.Password);
                ...
                if (user != null)
                {
                    ...
                    var authPropertities = new AuthenticationProperties();
                    authPropertities.IsPersistent = model.RememberMe;
                    authManager.SignIn(authPropertities, identityclaims);
